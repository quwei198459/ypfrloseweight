...
@TableName("skin_detection_item_config")
public class SkinDetectionItemConfig {

  @TableId(type = IdType.AUTO)
  private Long id;

  private String itemCode;
  private String yimeiField;
  ...
  public String getYimeiField() { return yimeiField; }
  public void setYimeiField(String yimeiField) { this.yimeiField = yimeiField; }
  public Long getDetectType() { return detectType; }
  public void setDetectType(Long detectType) { this.detectType = detectType; }
